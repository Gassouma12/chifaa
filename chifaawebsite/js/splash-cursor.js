// Vanilla JavaScript Splash Cursor Effect
(function () {
    'use strict';
    ...
    function initSplashCursor(options = {}) {
        ...
        container.style.cssText = 'position:fixed;top:0;left:0;z-index:9999;pointer-events:none;width:100%;height:100%';
    ...
    float decay=1.0+dissipation*dt;gl_FragColor=result/decay;}`, ext.supportLinearFiltering ? null : ['MANUAL_FILTERING']);
        ...
        function generateColor() {
            // Chifaa color palette
            const colors = [
                { r: 0.996, g: 0.702, b: 0 },      // #FEB300 - Primary Yellow
                { r: 0, g: 0.299, b: 0.910 },      // #004CE8 - Blue
                { r: 0.933, g: 0.204, b: 0.196 },  // #EE3432 - Red
                { r: 1, g: 0.6, b: 0.635 },        // #FF99A2 - Pink
                { r: 1, g: 0.286, b: 0 },          // #FF4900 - Orange
                { r: 0.349, g: 0.796, b: 0.788 }   // #59CBC9 - Teal/Blue-green
            ];
    ...
    // Auto-initialize when DOM is ready (desktop only)
    if (!isMobileDevice()) {
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', function () {
                window.splashCursor = initSplashCursor();
            });
        } else {
            window.splashCursor = initSplashCursor();
        }
